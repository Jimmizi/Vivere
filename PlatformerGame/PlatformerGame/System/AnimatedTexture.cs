...
//using the animated sprite example from:
// http://msdn.microsoft.com/en-us/library/bb203866%28v=xnagamestudio.40%29.aspx
...
namespace PlatformerGame
{
    public class AnimatedTexture
    {
        ...
        public void resetFrame(int newFrame = 0)
        {
            Frame = newFrame;
        }
